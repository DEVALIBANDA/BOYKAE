...
sudo_users = {SUDO,1366055467,1366055467,}   
...
local UserName = (data.username_ or "SOURCENASA")
...
usertext = '\n ☤ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCENASA')..')'
status  = '\n ☤ تم ترقيته مطور'
...
usertext = '\n ☤ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n ☤ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☤ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n ☤ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ☤ العضو : {["..data.first_name_.."](T.ME/SOURCENASA)}\n ☤ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☤ عذرا » {["..data.first_name_.."](T.ME/SOURCENASA)}\n ☤ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
╭──── • ◈ • ────╮
𖢵𝗦𝗢𝗨𝗥𝗖𝗘 𝗡𝗔𝗦𝗔𖠱²²
𖢵[𝗗𝗘𝗩⇒𝗕𝗔𝗡𝗗𝗔](t.me/uu_ban) 
𖢵[𝗗𝗘𝗩 ⇒𝗕𝗢𝗬𝗞𝗔](t.me/b_o_y_k_a_a) 
𖢵[𝗗𝗘𝗩⇒𝗘𝗟𝗞𝗢𝗠𝗔𝗡𝗗𝗔](t.me/Elkomanda_y3m) 
𖢵[𝗖𝗛⇒𝗡𝗔𝗦𝗔𖠱²²](t.me/SOURCENASA) 
╰──── • ◈ • ────╯
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☤ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n ☤ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☤ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCENASA')..') \n ☤ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.id_) == tonumber(1458654225) then  
send(msg.chat_id_, msg.id_, "☤ لا تستطيع كتم او حظر او تقييد مطور السورس")
return false 
end
...
local TextE = "\n≪━━━━━━𝗡𝗔𝗦𝗔𖠱²²♫ ━━━━━━≫\n ☤ علامة تعني { ✓ } ملف مفعل\n ☤ علامة تعني { ✘ } ملف معطل\n ☤ قناة سورس النهاية ↓\n".." ☤ [اضغط هنا لدخول](t.me/SOURCENASA) \n"
local NumFile = 0
...
local UserName = (b.username_ or "SOURCENASA")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☤ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
status  = '\n ☤ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☤ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☤ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☤ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCENASA')..')'..'\n ☤ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCENASA')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_, t..'ٴ☤ٴ≪━━━━━━𝗡𝗔𝗦𝗔𖠱²²♫ ━━━━━━≫ٴ☤○ٴ\n☤ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/SOURCENASA)➢ ')
end
